...
describe('EasySql Column test', () => {
    test('Simple column declaration', () => {
        ...
        expect(columnEnum.toString()).toBe("test_enum ENUM('val_1','val_2','val_3')")
    })
    ...
    test('Id column number auto increment', () => {
        ...
        expect(idColumn.toString()).toBe('id INT NOT NULL AUTO_INCREMENT PRIMARY KEY')
    })
    ...
    test('Date column by default today', () => {
        ...
        expect(dateColumn.toString()).toBe('begin DATE DEFAULT CURRENT_TIMESTAMP')
    })
    ...
    test('State column with a comment', () => {
        ...
        expect(stateColumn.toString()).toBe("state ENUM('To do','Doing','Done') DEFAULT 'To do' COMMENT 'This is the state of the task'")
    })
    ...
    test('Unique email column', () => {
        ...
        expect(emailColumn.toString()).toBe('email VARCHAR(30) NOT NULL UNIQUE')
    })
    ...
    test('Invisible description column', () => {
        ...
        expect(descriptionColumn.toString()).toBe("description VARCHAR(255) NOT NULL DEFAULT '' INVISIBLE")
    })
    ...
    test('Order on column', () => {
        ...
        expect(dateColumn.toString()).toBe('begin DATE DEFAULT CURRENT_TIMESTAMP FIRST')
